function [Rover,RRTState1] = replanERRT(RRTState, Rover,n)
disp('Replanning')
RRTState1 = RRTState;
RRTState1.Obstacles = Rover.Obstacles;
RRTState1.PointA = Rover.prev_wayPoint;
RRTState1.PointB = RRTState.PointB;
...
%%************************************************************************************
    ...
    while RRTState1.iteration.count < RRTState1.iteration.max
        ...
        RRTState1.q_new =  [rand()*RRTState1.Dimensions.Length,rand()*RRTState1.Dimensions.Width];        
...
Rover.waypoints =[];  
% disp(RRTState1.finalpathvertices);
Rover.waypoints = [waypoint1;RRTState1.finalpathvertices(2:size(RRTState1.finalpathvertices,1),1:2);RRTState1.PointB];
