...
% Obstacles.X = [Obstacles.X;new_obstacle_x];
Obstacles.Y = obstacleY;
% Obstacles.Y = [Obstacles.Y;new_obstacle_y];
Obstacles.Centers = obstacleCenters;

% Obstacles.Centers = [Obstacles.Centers;new_obstacle_center];
numObstacles = size(Obstacles.Centers,1);
